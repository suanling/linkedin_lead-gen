...
> FORMAT — never change them. The lines under each direction are the worked EXAMPLES,
> filled in your voice during /onboard (the Taste Interview). Until then they read [xxx].
> The post skill picks a format and fills the brackets with your content.
>
...
> markers in moderation ("honestly," "here's what I mean"), write to one real person, and keep it
...
[Explain the logic behind this process]
[xxx]
...
[Image: Simple visual showing progression from single salary to multiple income sources and what that means for flexibility and choices]
...
[Image: Chart showing single income volatility vs multiple income streams stability]
...
[Image: A simple two-column visual. Left column: one salary, one employer, one point of failure — labelled "what most people have." Right column: investment portfolio, advisory income, coaching/consulting, and skills that the market pays for — labelled "what financial flexibility actually looks like." Both columns show the same person; the difference is what they built in parallel.]
