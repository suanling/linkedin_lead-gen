...
- **AI named explicitly.** The locked positioning is AI-forward (`kk-post.md`). Say what AI carries: the repeatable, predictable execution. A post about the core problem that never mentions AI has missed the positioning.
