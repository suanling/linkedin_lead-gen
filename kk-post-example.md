...
> Library of LinkedIn post-format templates. The [bracketed stage directions] are the
> FORMAT — never change them. The lines under each direction are illustrative WORKED EXAMPLES,
> written here in a generic "left-corporate solopreneur" voice purely to show how each format
> gets filled. They are NOT your content. During `/onboard` (the Taste Interview) these get
> replaced with worked examples in YOUR own voice and stories.
>
> Use these examples for the SHAPE and concreteness only (real numbers, real scenes, short
> punchy lines, a sharp close), then overwrite them with your material. When filling, apply the
> "HUMAN TEXTURE" section of `.claude/rules/anti-ai.md` and the owner-specific material in
> `references/about-me.md` and `references/voice-profile.md`: open on recognition, write to one real person, stay concrete,
> stay inside the HARD NOS (no em dashes, close on a firm point).
...
- what peers thought of me

[Describe the things you care about now]
...
[Hit them with a vague, but easily relatable problem/feeling]
Promote yourself.
...
[This is something I cherish/my favorite thing]
It's still one of my favourite memories.

[Conclude with a call-to-action or positive message]
Want to be happy at work? Find people who treat you like that.


---15. Encourage Readers to Challenge Conventional Wisdom---

[Describe the current status of a universally-accepted problem]
People are stressed.
...
[Showcase the growth progression of a past behavior/experience/skill]
My raises as an employee:
...
[xxx]
2. If you don't, please share this.
...
[You're being victimized by a system that's rigged against you]
...
[Something happened recently that's got you thinking]
Yesterday a guy power-washed our driveway for a tidy sum in about 90 minutes.

[Things get even more surprising]
Says he's booked out for six weeks. Wow.

[You understand it's not that simple]
Yes, I know there are upfront costs, scale issues, seasonality, and so on.

[Reflect on the meaning of what happened]
But honestly, these "unglamorous" businesses deserve more respect.
...
---32. The Evolution of a Mindset---

[Introduce a common thought among beginners in your industry]
Beginners: I got 3,000 views.

[Contrast this with a more experienced mindset]
Amateurs: I got 3,000 likes.

[Take this thought to its ultimate conclusion]
...
[Break down the math or logic behind a desirable outcome]
The math behind a healthy online business:
...
[xxx]
The difference is depth, not tricks.

[It's not about superficial tactics]
...
---46. Show Them How to Be Better---

[Describe an undesirable behavior or belief that's common among your audience]
...
[State the inevitable outcome of this opposite behavior]
That's how you actually win.

[xxx]
Abundance is a strategy, not a personality.
...
---49. The Two-Line Proverb---

[Simplify an otherwise complex topic through a practical analogy, example, or poetically concise statement]
...
[X is a valuable resource]
Your time is money.

[Here's how to waste it]
Don't spend it on:
- reading junk
- arguing online
- endless scrolling
...
[Finish with a rhetorical question to motivate readers]
Are you going to go get it?


---54. The Beginner's Guide + Image---

[Topic X 101]
Social Media Engagement 101

[Embed an illustration or graphic that explains this topic in a simple, but meaningful way]
[Image: a simple flow from comment, to connection, to conversation, to client.]
...
[Encourage readers to take a particular action]
...
---59. Tell Them How to Achieve Their Goals on a Limited Budget---
...
---64. Invite Them to Try Something New---

[Try X within a specific timeframe]
...
[Start with an inclusion or exclusion question]
Who here has $100?

[Elaborate on common symptoms/behaviors]
Ready to spend it? Clothes? A gadget? Another impulse buy?
...
[It might be slow]
It might take 3 months. Or 6. Or 12.

[But again, it's worth it]
But when it clicks, it really clicks.

[This is the ultimate benefit/result they'll get from following your advice]
More income and more freedom.

[Finish with two consecutive CTAs]
Play the long game. Invest in yourself.


---70. Challenge Their Paradigms---

[Start with a rhetoric question that challenges the status quo]
...
[Use sarcasm or humor to make your point]
Their "secure" jobs.
...
Don't build a content calendar. Write one post.
...
---73. There's Always Something Worse---

[Doing X is challenging/hard/time-consuming]
Starting a business is hard.

[Doing Y is worst/more painful/impossible]
Staying in a job you hate is harder.


---74. Share What Truly Matters---

[List four things that are crucial and relevant to your brand positioning]
Do good work, love your family, help people, and see the world.
...
[xxx]
- I didn't want to look back and not recognise my own life.
...
[Start with a personalized introduction for the platform]
LinkedIn network...
...
[Summarize in the simplest terms]
Systems win.
...
[TL;DR]
In short:
- ideate with topics and structures
...
[Conventional wisdom teaches this]
What the world teaches you:

[List the conventional advice/wisdom]
...
[Use an image to illustrate an otherwise complex concept]
True wealth.
[Image: a calm morning with no alarm, a coffee, and an open calendar with nothing urgent on it.]
...
[Take a desired result to an almost absurd extreme to make a point]
Build something so good that the right opportunities start applying to you.


---94. Break Down the Recipe---

[Element 1 = Result 1]
Content = makes people aware of you.
...
[Since I started doing X, I've...]
Since I started creating content, I've:

[List the things you've accomplished]
- left my job
- built a few small businesses
...
[Audience X tends to behave this way]
Things most people do:
- watch a ton of video
- read endless self-help
- binge shows
- scroll all day
...
[Here's what audience X doesn't do]
...
[Close and invite them to take action]
...
[One-word CTA that's easy to internalize and act on]
Leverage.
...
[Select the people you want to connect with and state your intention]
If you're earlier in your journey, drop two lines below:

[Describe the criteria they should meet]
What do you do? And one other creator worth following?
